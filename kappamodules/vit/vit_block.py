...
class VitBlock(nn.Module):
    def __init__(
        ...
        attn_ctor = DotProductAttention if use_flash_attention else DotProductAttentionSlow
        ...
        self.mlp = VitMlp(in_dim=dim, hidden_dim=mlp_hidden_dim, act_layer=act_layer)
